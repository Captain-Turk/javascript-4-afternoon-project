...
console.log(bob)
  ...
  */
  ...
  // Code here
  Movie.prototype.changeRating = function(numb){
    return this.rating  = (this.rating + numb) / 2
  }
  ////////// PROBLEM 5 //////////
  ...
  // //   // name: 'string' , email: 'string', age: number, savedPosts= {}
  //   this.name = name
  //   this.age = age
  //   this.email = email
  //   this.savedPosts = savedPosts [this.id, this.title, this.rating]
  ...
  //   }
    ...
    function User(name, age, email){
      //   // name: 'string' , email: 'string', age: number, savedPosts= {}
        ...
        this.email = email
        this.savedPosts = []
        // this.savedPosts = function SavedPost(id, title, rating){
        // id (a number), title (a string), and rating (a number between 1 and 5)
          //  this.id = id
          //  this.title = title
          //  this.rating = rating
  ...
  // id (a number), title (a string), and rating (a number between 1 and 5)
      ...
      //   this.rating = rating
      // }
      // return this.savedPosts.push(savedPost)
  }   
       
  // this.savedPosts.push(addSavedPosts())
      

      // return user.savedPosts.bind(addSavedPosts)
